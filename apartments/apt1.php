        ...
        <div class="row">
            ...
            <div class="col-lg-9" align="center">
                <div class="thumbnails">
                    <br>
                    <img onmouseover="preview.src=img1.src" name="img1" src="../indeximg/compressjpeg/apartment1/commonroom.jpg" alt=""/>
                    <img onmouseover="preview.src=img2.src" name="img2" src="../indeximg/compressjpeg/apartment1/front.jpg" alt=""/>
                    <img onmouseover="preview.src=img3.src" name="img3" src="../indeximg/compressjpeg/apartment1/kitchen.jpg" alt=""/>
                    <img onmouseover="preview.src=img4.src" name="img4" src="../indeximg/compressjpeg/apartment1/bedroom.jpg" alt=""/>    
                </div>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment WHERE aptID='apt1'");
                ...
                $res1=$con-> query("SELECT * FROM landlord WHERE landlordID='3'");
                    ...
                    // output data of each row
                        ...
                        <div class='overview'>
                            ...
                            <iframe class='map'
                                ...
                                src='https://www.google.com/maps/embed/v1/search?key=AIzaSyDJzTd1_Q6qX-Z2dizhXutNzOs7T__tWsk&q=bedessie+street+st+augustine'>
                            </iframe>
                        </div>";
                        }
                    }else{
