        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="../type/furnished.php" class="list-group-item active">Fully Furnished Units</a>
                ...
                <div class="list-group">
                    ...
                    <a href="../price/range3.php" class="list-group-item active">$3000+</a>
                </div>

                 <p class="lead">Proximity To Campus</p>
                <div class="list-group">
                    <a href="../proximity/time1.php" class="list-group-item">5 Minutes</a>
                    <a href="../proximity/time2.php" class="list-group-item active">10 Minutes</a>
            ...
            <div class="col-lg-9" align="center">
                <div class="thumbnails">
                    <br>
                    <img onmouseover="preview.src=img1.src" name="img1" src="../indeximg/compressjpeg/apartment2/outside.jpg" alt=""/>
                    <img onmouseover="preview.src=img2.src" name="img2" src="../indeximg/compressjpeg/apartment2/bath.jpg" alt=""/>
                    <img onmouseover="preview.src=img3.src" name="img3" src="../indeximg/compressjpeg/apartment2/kitchen.jpg" alt=""/>
                    <img onmouseover="preview.src=img4.src" name="img4" src="../indeximg/compressjpeg/apartment2/bedroom.jpg" alt=""/>    
                </div>
            ...
            <?php
                ...
                $res1=$con-> query("SELECT * FROM landlord WHERE landlordID='2'");
                       ...
                       echo"
                        <div class='overview'>
                            ...
                            <iframe class='map'
                                ...
                                src='https://www.google.com/maps/embed/v1/search?key=AIzaSyDJzTd1_Q6qX-Z2dizhXutNzOs7T__tWsk&q=old%20tim+street+st+augustine'>
                            </iframe>
                        </div>";
                        }
                    }else{
