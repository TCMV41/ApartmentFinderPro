        ...
        <div class="row">
            ...
            <div class="col-lg-9" align="center">
                <div class="thumbnails">
                    <br>
                    <img onmouseover="preview.src=img1.src" name="img1" src="../indeximg/compressjpeg/apartment3/apt3.jpg" alt=""/>
                    <img onmouseover="preview.src=img2.src" name="img2" src="../indeximg/compressjpeg/apartment3/front.jpg" alt=""/>
                    <img onmouseover="preview.src=img3.src" name="img3" src="../indeximg/compressjpeg/apartment3/kitchen.jpg" alt=""/>
                    <img onmouseover="preview.src=img4.src" name="img4" src="../indeximg/compressjpeg/apartment3/washroom.jpg" alt=""/>    
                </div>
            ...
            <?php
                ...
                $res1=$con-> query("SELECT * FROM landlord WHERE landlordID='1'");
