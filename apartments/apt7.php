        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="../type/studio.php" class="list-group-item active">Studio Apartments</a>
                ...
                <div class="list-group">
                    <a href="../price/range1.php" class="list-group-item active">$1500-$2000</a>
                ...
                <div class="list-group">
                    ...
                    <a href="../proximity/time3.php" class="list-group-item active">15+ Minutes</a>
                </div>
            </div>
            ...
            <div class="col-lg-9" align="center">
                 <div class="thumbnails">
                    <br>
                    <img onmouseover="preview.src=img1.src" name="img1" src="../indeximg/compressjpeg/apartment7/apt7.jpg" alt=""/>
                    <img onmouseover="preview.src=img2.src" name="img2" src="../indeximg/compressjpeg/apartment7/bathroom.jpg" alt=""/>
                    <img onmouseover="preview.src=img3.src" name="img3" src="../indeximg/compressjpeg/apartment7/livingroom.jpg" alt=""/>
                    <img onmouseover="preview.src=img4.src" name="img4" src="../indeximg/compressjpeg/apartment7/bedroom.jpg" alt=""/>
                    <img onmouseover="preview.src=img5.src" name="img5" src="../indeximg/compressjpeg/apartment7/kitchen.jpg" alt=""/>    
                </div>
           ...
           <?php
                ...
                $res=$con-> query("SELECT * FROM apartment WHERE aptID='apt7'");
