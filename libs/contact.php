...
<body>
  <!-- Navigation -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-1">
                <ul id="nbar" class="nav navbar-nav">
                    ...
                    <li><a id="reg" href="login.php">Register/Login</a></li>
                    <li><a id="hl" class="active" href"#contact">Contact</a></li>
    ...
    <script type="text/javascript" defer src="//www.123contactform.com/embed/2575282.js" data-role="form"></script>
    <!-- www.123contactform.com script ends here -->

    <h5 class="test">Email: AJARCSI@GMAIL.COM</h5>
    <h5 class="test">Telephone: 765-4321</h5>
