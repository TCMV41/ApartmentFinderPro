        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="#$2000-$3000" class="list-group-item active">$2000-$3000</a>
                    <a href="range3.php" class="list-group-item">$3000+</a>
                </div>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment WHERE price>2000 AND price<3000");
