        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-1">
                <ul id="nbar"class="nav navbar-nav">
                   ...
                   <li><a id="btnLogout" class="btn btn-action hide" href="../libs/about.php">Logout</a><li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="range1.php" class="list-group-item">$1500-$2000</a>
                    <a href="range2.php" class="list-group-item">$2000-$3000</a>
                    <a href="#$3000+" class="list-group-item active">$3000+</a>
                </div>

                <p class="lead">Proximity To Campus (Walking)</p>
                <div class="list-group">
                    <a href="../proximity/time1.php" class="list-group-item">5 Minutes Away</a>
                    <a href="../proximity/time2.php" class="list-group-item">10 Minutes Away</a>
                    <a href="../proximity/time3.php" class="list-group-item">15+ Minutes Away</a>
                </div>
            </div>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment WHERE price>3000");
