    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="#10 Minutes Away" class="list-group-item active">5 Minutes</a>
                    <a href="time2.php" class="list-group-item">10 Minutes</a>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment INNER JOIN landlord WHERE landlord.landlordID=apartment.landlordID AND distance<=5");
