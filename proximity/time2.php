...
<head>
    ...
    <title>10-15 Minutes Away</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-1">
                <ul id="nbar" class="nav navbar-nav">
                    ...
                    <li><a id="btnLogout" class="btn btn-action hide" href="exit.php">Logout</a>
                        <li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="../range/range1.php" class="list-group-item">$1500-$2000</a>
                    <a href="../range/range2.php" class="list-group-item">$2000-$3000</a>
                    <a href="../range/range3.php" class="list-group-item">$3000+</a>
                </div>

                <p class="lead">Proximity To Campus</p>
                <div class="list-group">
                    <a href="time1.php" class="list-group-item">5 Minutes</a>
                    <a href="#15 Minutes Away" class="list-group-item active">10 Minutes</a>
                    <a href="time3.php" class="list-group-item">15+ Minutes</a>
                </div>
            </div>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment INNER JOIN landlord WHERE landlord.landlordID=apartment.landlordID AND distance>5 AND distance <=10");
