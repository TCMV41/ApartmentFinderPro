        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="#15+ Minutes Away" class="list-group-item active">15+ Minutes</a>
                </div>
            </div>
            ...
            <?php
                ...
                $res=$con-> query("SELECT * FROM apartment INNER JOIN landlord WHERE landlord.landlordID=apartment.landlordID AND distance>15");
