        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="#furnished" class="list-group-item active">Fully Furnished Units</a>
                    <a href="unfurnished.php" class="list-group-item">Unfurnished Units</a>
                </div>
                ...
                <?php
                    ...
                    $res=$con-> query("SELECT * FROM apartment WHERE name='Furnished'");
